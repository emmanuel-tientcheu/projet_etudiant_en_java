...
public class Main {
    public static void main(String[] args){
        ...
        do{
            ...
            System.out.println("6-Reinisialiser le tableau d'etudiant");
    ...
    public static Etudiant[] Reset(Etudiant[]tableau){
        tableau = null ;
        int nombre = 0 ;
        Scanner sc = new Scanner(System.in);
        System.out.print("entrez le nouveau nombre d'etudiant: ");
        nombre = sc.nextInt();
        tableau = new Etudiant[nombre];
        sc.nextLine();
